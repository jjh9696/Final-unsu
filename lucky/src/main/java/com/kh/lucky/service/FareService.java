...
//   //포인트 차감
//	public PaymentDto minusPoint(String chargeType, int routeNo, int count) {
//	      ChargeDto addChargeDto = chargeDao.selectOne(10);
//	      List<ChargeDto> chargesByAge = chargeDao.selectOneByAge(chargeType);
//	      if (chargesByAge.isEmpty()) {
//	         throw new RuntimeException("No charges found for the given age type.");
...
//			
//	      //포인트 차감
//	      System.out.println("페이먼트Dto안에아이디:"+paymentDto.getMemberId());
//	      MemberDto memberDto = memberDao.selectId(memberId);
//	      System.out.println("멤버아이디:"+memberId);
//	      
//	      boolean hasPoint = memberDto.getMemberPoint() >= baseFare;
//	      
//	      if(hasPoint) {
//				int totalPoint = memberDto.getMemberPoint() - baseFare;
//				memberDto.setMemberPoint(totalPoint);
//				System.out.println("남은 포인트:"+totalPoint);
//				
